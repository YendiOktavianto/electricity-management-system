...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">THDv</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Monitoring THDv</h6>
        </nav>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rs1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rs1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_st1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_st1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rt1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rt1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rn1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rn1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            </div><div class="col-lg-12 col-md-12 mb-4">
              <div class="card">
              <div class="card-body">
                <div class="row">
                  <div class="col-8">
                    <h3>THDv S-N (Input) </h3>
                    <p class="text-sm mb-0">
                      <i class="fa fa-chart-line text-info" aria-hidden="true"></i>
                      <span class="font-weight-bold ms-1">Monitoring Realtime</span> 
                    </p>
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_sn1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_sn1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_tn1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_tn1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rs2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rs2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_st2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_st2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rt2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rt2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rn2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_rn2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_sn2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_sn2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_tn2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdv_tn2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      setInterval(function () {
        $.ajax({
          url:  '<?php echo base_url(); ?>getdata/thdv',
          success: function (point) {
            ...
            vsn2 = data11;
            vtn2 = data12;
            var point1 = $('#thdv_rs1b').highcharts().series[0].points[0];       
            point1.update(vrs1);
            var point2 = $('#thdv_st1b').highcharts().series[0].points[0];       
            point2.update(vst1);
            var point3 = $('#thdv_rt1b').highcharts().series[0].points[0];       
            point3.update(vrt1);
            var point4 = $('#thdv_rn1b').highcharts().series[0].points[0];       
            point4.update(vrn1);
            var point5 = $('#thdv_sn1b').highcharts().series[0].points[0];       
            point5.update(vsn1);
            var point6 = $('#thdv_tn1b').highcharts().series[0].points[0];       
            point6.update(vtn1);
            var point7 = $('#thdv_rs2b').highcharts().series[0].points[0];       
            point7.update(vrs2);
            var point8 = $('#thdv_st2b').highcharts().series[0].points[0];       
            point8.update(vst2);
            var point9 = $('#thdv_rt2b').highcharts().series[0].points[0];       
            point9.update(vrt2);
            var point10 = $('#thdv_rn2b').highcharts().series[0].points[0];       
            point10.update(vrn2);
            var point11 = $('#thdv_sn2b').highcharts().series[0].points[0];       
            point11.update(vsn2);
            var point12 = $('#thdv_tn2b').highcharts().series[0].points[0];       
            point12.update(vtn2);
