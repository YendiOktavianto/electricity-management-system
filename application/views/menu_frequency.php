      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Frequency</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Monitoring Frequency</h6>
        </nav>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="frequency_1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="frequency_1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="frequency_2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="frequency_2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    Highcharts.chart('frequency_1b', {
        ...
        yAxis: {
	        ...
	        pane: 0,
	        title: {
	            text: 'Hz<br/><span style="font-size:24px">Frequency</span>',
	            y: -30
	        }
	    },
    ...
    $(document).ready(function() {
      setInterval(function () {
        $.ajax({
          url:  '<?php echo base_url(); ?>getdata/frequency',
          success: function (point) {
            ...
            vgnd1 = data1;
            vgnd2 = data2;
            var point1 = $('#frequency_1b').highcharts().series[0].points[0];       
            point1.update(vgnd1);
            var point2 = $('#frequency_2b').highcharts().series[0].points[0];       
            point2.update(vgnd2);
