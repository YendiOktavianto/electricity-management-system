...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Temperature</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Monitoring Temperature</h6>
        </nav>
              ...
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-4 col-md-auto d-flex flex-column justify-content-center align-items-center">
                    <div class="connection-indicator temp-indicator mb-2" id="connectionStatus"></div>
                    <div class="device-status temp-status" id="deviceStatusText">DEVICE OFFLINE</div>
                  </div>
                </div>
              </div>
                <div class="row">
                  <div class="col-lg-5 col-md-5">
                    <div class="card-body">
                      <div id="temp1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-7 col-md-7">
                    <div class="card-body">
                      <div id="temp1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-5 col-md-5">
                    <div class="card-body">
                      <div id="temp2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-7 col-md-7">
                    <div class="card-body">
                      <div id="temp2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-5 col-md-5">
                    <div class="card-body">
                      <div id="temp3b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-7 col-md-7">
                    <div class="card-body">
                      <div id="temp3a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
        ...
        events: {
          load: function () {
            ...
            setInterval(function () {
              ...
              series.addPoint([x, temp1], true, true);
            },2000);
          }
        }
      },
      ...
      chart: {
        ...
        events: {
          load: function () {
            ...
            setInterval(function () {
              var x = (new Date()).getTime();
              series.addPoint([x, temp2], true, true);
            },2000);
          }
        }
      },
      ...
      chart: {
        ...
        events: {
          load: function () {
            ...
            setInterval(function () {
              var x = (new Date()).getTime();
              series.addPoint([x, temp3], true, true);
            },2000);
          }
        }
      },
    ...
    $(document).ready(function() {
      setInterval(function () {
        $.ajax({
          url:  '<?php echo base_url(); ?>getdata/temperature',
          success: function (point) {
            ...
            temp2 = data2;
            temp3 = data3;
            var point1 = $('#temp1b').highcharts().series[0].points[0];       
            point1.update(temp1);
            var point2 = $('#temp2b').highcharts().series[0].points[0];       
            point2.update(temp2);
            var point3 = $('#temp3b').highcharts().series[0].points[0];       
            point3.update(temp3);
...
<script>
    ...
    setInterval(function() {
      $.ajax({
            url: '<?php echo base_url(); ?>writedata/check_last_data_suhu',
            success: function(response){
                if(response == "OFFLINE") {
                    $('.temp-indicator').css('background-color', 'red');
                    $('.temp-status').css('border-color', 'red').text('DEVICE OFFLINE');
                } else if(response == "ONLINE") {
                    $('.temp-indicator').css('background-color', 'green');
                    $('.temp-status').css('border-color', 'green').text('DEVICE ONLINE');
                } else if(response == "TRANSMIT") {
                    $('.temp-indicator').css('background-color', 'black');
                    $('.temp-status').css('border-color', 'black').text('TRANSMIT DATA');
                }
            } 
        });
      }, 1500); 
