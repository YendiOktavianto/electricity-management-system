...
<body class="g-sidenav-show  bg-gray-200">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">THDI</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Monitoring THDi</h6>
        </nav>
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_r1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_r1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_s1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_s1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_t1b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_t1a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_r2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_r2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_s2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_s2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-12 col-md-12 mb-4">
              ...
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_t2b" style="height: 250px; min-width: 225px; max-width: 290px; margin: 0 auto;"></div>
                    </div>
                  </div>
                  <div class="col-lg-6 col-md-6">
                    <div class="card-body">
                      <div id="thdi_t2a" style="height: 250px;"></div>
                    </div>
                  </div>
                </div>
              </div>
  ...
  <script type="text/javascript">
    ...
    $(document).ready(function() {
      setInterval(function () {
        $.ajax({
          url:  '<?php echo base_url(); ?>getdata/thdi',
          success: function (point) {
            ...
            ist2 = data5;
            irt2 = data6;
            var point1 = $('#thdi_r1b').highcharts().series[0].points[0];       
            point1.update(irs1);
            var point2 = $('#thdi_s1b').highcharts().series[0].points[0];       
            point2.update(ist1);
            var point3 = $('#thdi_t1b').highcharts().series[0].points[0];       
            point3.update(irt1);
            var point4 = $('#thdi_r2b').highcharts().series[0].points[0];       
            point4.update(irs2);
            var point5 = $('#thdi_s2b').highcharts().series[0].points[0];       
            point5.update(ist2);
            var point6 = $('#thdi_t2b').highcharts().series[0].points[0];       
            point6.update(irt2);
